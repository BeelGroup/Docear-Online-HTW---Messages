define ['views/RootNodeView', 'views/NodeView', 'views/HtmlView', 'models/Node', 'models/RootNode', 'MindMapPositioner'],  (RootNodeView, NodeView,HtmlView,NodeModel,RootNodeModel,Positioner) ->  
